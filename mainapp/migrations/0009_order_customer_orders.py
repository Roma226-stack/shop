...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0008_alter_customer_address_alter_customer_phone'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий к закказу')),
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_order', to='mainapp.Order', verbose_name='Закакзы покупателя'),
        ),
    ]
